...
def summarise(reviews, model):
    prompt = "I collected some reviews about this place that I am considering visiting. Can you summarise the reviews for me? I want to know what people like and dislike about the place."
...
if __name__ == "__main__":
    ...
    while True:
        user_input = input("Which reviews do you want to summarise? Paste a link or click 'q' to exit.\n")
        if user_input == "q": break
        try:
            reviews = asyncio.get_event_loop().run_until_complete(scrape_reviews(user_input))
            print(summarise(reviews, model))
